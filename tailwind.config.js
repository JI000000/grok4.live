  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glow-lg': '0 0 40px rgba(29, 155, 240, 0.2)',
      ...
      keyframes: {
        ...
        glow: {
          '0%': { boxShadow: '0 0 5px rgba(29, 155, 240, 0.2)' },
          '100%': { boxShadow: '0 0 20px rgba(29, 155, 240, 0.6)' },
        },
      },
      backdropBlur: {
        xs: '2px',
