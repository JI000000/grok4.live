...
export function VideoCard({ video, className, showAnalysis = false }: VideoCardProps) {
  ...
  return (
    <div className={cn(
      'group bg-gray-950/50 border border-gray-800 rounded-xl overflow-hidden',
      ...
      <div className="relative aspect-video bg-gray-900 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black/30 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          <div className="w-16 h-16 bg-white/90 rounded-full flex items-center justify-center backdrop-blur-sm hover:bg-white transition-colors">
      ...
      <div className="p-6">
        ...
        <div className="flex items-center gap-3 mt-4 pt-4 border-t border-gray-800">
          <button className="flex-1 bg-brand-500 hover:bg-brand-600 text-white text-sm font-medium py-2 px-4 rounded-lg transition-colors flex items-center justify-center gap-2">
            <PlayIcon className="w-4 h-4" fill="currentColor" />
            {video.isLive ? 'Join Live' : 'Watch Now'}
          </button>
          
          <button className="p-2 bg-gray-800/50 hover:bg-gray-700/50 text-gray-400 hover:text-white rounded-lg transition-colors">
