...
export const sampleVideos: Video[] = [
  ...
  },
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1677442136019-21780ecad995?w=800&h=450&fit=crop&q=80',
    embedUrl: 'https://www.youtube.com/embed/8A8jvlV9qwE',
    duration: 892, // 14:52
    quality: ['1080p', '720p'],
    subtitles: [{ language: 'en', url: '/subtitles/grok-4-benchmarks-en.vtt', label: 'English' }],
    views: 45230,
    likes: 3240,
    shares: 850,
    comments: 234,
    publishedAt: '2025-07-13T08:00:00Z',
    updatedAt: '2025-07-13T08:00:00Z',
    category: 'ANALYSIS',
    featured: true,
    tags: ['Grok 4', 'benchmarks', 'AI performance', 'multi-agent'],
    relatedArticles: ['grok-4-benchmarks-analysis'],
    relatedVideos: ['17', '18'],
    isPublic: true,
    allowComments: true,
    allowEmbedding: true,
  ...
  {
    id: '17',
    title: 'Grok 4 Heavy vs Standard: $300 vs $30 - Which Should You Choose?',
    description: 'Complete comparison of Grok 4 pricing tiers. We test both versions on real-world tasks to help you decide if the Heavy tier is worth the premium.',
    thumbnail: 'https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=800&h=450&fit=crop&q=80',
    embedUrl: 'https://www.youtube.com/embed/W45B4M0PEQo',
    duration: 654, // 10:54
    quality: ['1080p', '720p'],
    subtitles: [{ language: 'en', url: '/subtitles/grok-4-pricing-en.vtt', label: 'English' }],
    views: 23890,
    likes: 1850,
    shares: 420,
    comments: 156,
    ...
    category: 'ANALYSIS',
    featured: true,
    tags: ['Grok 4', 'pricing', 'Heavy', 'comparison'],
  ...
  {
    id: '18',
    title: 'Grok 4 Multi-Agent Architecture: Inside the 32-Agent System',
    description: 'Technical deep dive into Grok 4 Heavy\'s revolutionary multi-agent architecture. How 32 parallel agents collaborate to solve complex problems.',
    thumbnail: 'https://images.unsplash.com/photo-1518186285589-2f7649de83e0?w=800&h=450&fit=crop&q=80',
    embedUrl: 'https://www.youtube.com/embed/Y2K3BvT6rPM',
    duration: 1108, // 18:28
    quality: ['1080p', '720p'],
    subtitles: [{ language: 'en', url: '/subtitles/grok-4-multiagent-en.vtt', label: 'English' }],
    views: 18745,
    likes: 1624,
    shares: 312,
    comments: 89,
    publishedAt: '2025-07-11T16:00:00Z',
    updatedAt: '2025-07-11T16:00:00Z',
    category: 'ANALYSIS',
    featured: true,
    tags: ['Grok 4', 'multi-agent', 'architecture', 'technical'],
    relatedArticles: ['grok-4-heavy-analysis'],
    relatedVideos: ['16', '17'],
    isPublic: true,
    allowComments: true,
    allowEmbedding: true,
  ...
  {
    id: '19',
    title: 'Grok 4 Live Demo: Watch AI Solve PhD-Level Physics in Real-Time',
    description: 'Incredible live demonstration of Grok 4 solving graduate-level physics problems. See the multi-agent system in action as it collaborates to find solutions.',
    thumbnail: 'https://images.unsplash.com/photo-1635070041078-e363dbe005cb?w=800&h=450&fit=crop&q=80',
    embedUrl: 'https://www.youtube.com/embed/P3K7M9kYnAs',
    duration: 720, // 12:00
    quality: ['1080p', '720p'],
    subtitles: [{ language: 'en', url: '/subtitles/grok-4-physics-demo-en.vtt', label: 'English' }],
    views: 31247,
    likes: 2890,
    shares: 640,
    comments: 198,
    publishedAt: '2025-07-10T20:00:00Z',
    updatedAt: '2025-07-10T20:00:00Z',
    category: 'BREAKING',
    featured: true,
    tags: ['Grok 4', 'physics', 'demo', 'live'],
    relatedArticles: ['grok-4-benchmarks-analysis'],
    relatedVideos: ['16', '18'],
    isPublic: true,
    allowComments: true,
    allowEmbedding: true,
    author: 'Live Demo Team',
  },
  {
    id: '20',
    title: 'Grok 4 vs GPT-4: The AGI Implications Nobody\'s Talking About',
    description: 'Comparative analysis of Grok 4\'s breakthrough performance and what it means for the race to AGI. Expert insights on the competitive landscape.',
    thumbnail: 'https://images.unsplash.com/photo-1485827404703-89b55fcc595e?w=800&h=450&fit=crop&q=80',
    embedUrl: 'https://www.youtube.com/embed/L8N5BvkY2wE',
    duration: 1512, // 25:12
    quality: ['1080p', '720p'],
    subtitles: [{ language: 'en', url: '/subtitles/grok-4-agi-implications-en.vtt', label: 'English' }],
    views: 42156,
    likes: 3567,
    shares: 892,
    comments: 445,
    ...
    category: 'ANALYSIS',
    featured: true,
    tags: ['Grok 4', 'AGI', 'comparison', 'GPT-4'],
  ...
  },
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=800&h=450&fit=crop&q=80',
  ...
  },
  {
    ...
    thumbnail: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=800&h=450&fit=crop&q=80',
  ...
  {
    id: '21',
    title: 'MechaHitler Incident: What Really Happened with Grok AI',
    description: 'Complete breakdown of the July 4th weekend controversy that shook the AI community. Technical analysis of the safety failures and xAI\'s response.',
    thumbnail: 'https://images.unsplash.com/photo-1677442136019-21780ecad995?w=800&h=450&fit=crop&q=80',
    embedUrl: 'https://www.youtube.com/embed/mechahitler-video',
    duration: 1245, // 20:45
    quality: ['1080p', '720p'],
    subtitles: [{ language: 'en', url: '/subtitles/mechahitler-en.vtt', label: 'English' }],
    views: 89432,
    likes: 5234,
    shares: 1450,
    comments: 890,
    publishedAt: '2025-07-10T18:30:00Z',
    updatedAt: '2025-07-10T18:30:00Z',
    category: 'BREAKING',
    featured: true,
    tags: ['MechaHitler', 'controversy', 'AI safety', 'xAI'],
    relatedArticles: ['mechahitler-incident-timeline'],
    relatedVideos: ['16', '17'],
    isPublic: true,
    allowComments: true,
    allowEmbedding: true,
